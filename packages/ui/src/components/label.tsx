...
function Label({ className, ...props }: React.ComponentProps<"label">) {
  return (
    // biome-ignore lint/a11y/noLabelWithoutControl: generic primitive — every real call site supplies htmlFor/children via ...props, which Biome's static check can't see across component boundaries
    <label
      className={cn(
