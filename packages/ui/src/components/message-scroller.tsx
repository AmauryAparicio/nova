...
// biome-ignore lint/performance/noBarrelFile: this export-from is the fix for lint/style/noExportedImports below — the two rules contradict here, a named non-wildcard re-export is the lesser tradeoff
export {
  useMessageScroller,
